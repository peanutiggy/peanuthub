...
CREATE TABLE `admin` (
  ...
  PRIMARY KEY (`Id`),
  UNIQUE KEY `adminName_UNIQUE` (`Name`)
...
CREATE TABLE `business` (
  ...
  `Explain` varchar(40) DEFAULT NULL COMMENT '商家介绍',
...
CREATE TABLE `food` (
  ...
  `Explain` varchar(30) DEFAULT NULL COMMENT '食品介绍',
  `Price` decimal(5,2) NOT NULL DEFAULT '0.00' COMMENT '食品价格',
