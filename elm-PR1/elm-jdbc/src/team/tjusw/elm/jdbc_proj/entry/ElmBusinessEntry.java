package team.tjusw.elm.jdbc_proj.entry;
...
import team.tjusw.elm.jdbc_proj.view.impl.BusinessViewImpl;
import team.tjusw.elm.jdbc_proj.view.impl.FoodViewImpl;
		...
		if(business!=null) {
			...
			while(menu!=5) {
				...
				System.out.println("\n======= 一级菜单（商家管理）1.查看商家信息=2.修改商家信息=3.更新密码=4.所属商品管理=5.退出系统=======");
						...
						switch(menu) {
						case 1:
							businessView.showBusiness(business.getId());
							break;
						case 2:
							businessView.editBusiness(business.getId());
							break;
						case 3:
							businessView.updateBussinessPassword(business.getId());
							break;
						case 4:
							foodManager(business.getId());
							break;
						case 5:
